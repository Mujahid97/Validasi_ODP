...
class MYR_MODEL extends CI_Model {
  public function filter($search, $limit, $start, $order_field, $order_ascdesc){
    ...
    return $this->db->get('SIIS_MYR')->result_array(); // Eksekusi query sql sesuai kondisi diatas
  }

  public function count_all(){
    return $this->db->count_all('SIIS_MYR'); // Untuk menghitung semua data siswa
  }
  ...
  public function count_filter($search){
    ...
    return $this->db->get('SIIS_MYR')->num_rows(); // Untuk menghitung jumlah data sesuai dengan filter pada textbox pencarian
  }
}