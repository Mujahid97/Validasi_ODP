...
<!-- Page Heading -->
<h1 class="h3 mb-2 text-gray-800">Data ODP SO WARU</h1>
...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary">WARU</h6>
  </div>
  <div class="card-body">
...
$(document).ready(function() {
    tabel = $('#wru-before').DataTable({
        ...
        "ajax":
        {
            "url": "<?php echo base_url('Data_Sebelumnya/WRU/view') ?>", // URL file untuk proses select datanya
            "type": "POST"
        },
        "deferRender": true,
