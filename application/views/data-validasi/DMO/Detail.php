...
<!-- Page Heading -->
<h1 class="h3 mb-2 text-gray-800">Rekap Drop Core DARMO</h1>
...
<div class="card shadow mb-4">
  ...
  <div class="card-body">
    <div class="table-responsive">
      <table class="table table-bordered" id="detail-dmo" width="100%" cellspacing="0">
        <thead>
          <tr>
...
$(document).ready(function() {
    tabel = $('#detail-dmo').DataTable({
        ...
        "ajax":
        {
            "url": "<?php echo base_url('Data_Validasi/DMO/view_detail') ?>", // URL file untuk proses select datanya
            "type": "POST"
        },
        "deferRender": true,
