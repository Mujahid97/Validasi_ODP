...
<p class="mb-4">PROGRES VALIDASI SERVICE STO JAGIR SAMPAI DENGAN TANGGAL 27 JULI 2019</p>
...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary">Validasi JGR</h6>
  </div>
  <div class="card-body">
...
$(document).ready(function() {
    tabel = $('#validasi').DataTable({
        ...
        "ajax":
        {
            "url": "<?php echo base_url('Data_Validasi/JGR/view_validasi') ?>", // URL file untuk proses select datanya
            "type": "POST"
        },
        "deferRender": true,
