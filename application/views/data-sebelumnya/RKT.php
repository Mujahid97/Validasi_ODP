...
<div class="card shadow mb-4">
  ...
  <div class="card-body">
    <div class="table-responsive">
      <table class="table table-bordered" id="siis-rkt" width="100%" cellspacing="0">
        <thead>
          <tr>
          <th>REGIONAL</th>
          <th>WITEL</th>
...
$(document).ready(function() {
    tabel = $('#siis-rkt').DataTable({
        ...
        "ajax":
        {
            "url": "<?php echo base_url('Data_Sebelumnya/RKT/view') ?>", // URL file untuk proses select datanya
            "type": "POST"
        },
        "deferRender": true,
