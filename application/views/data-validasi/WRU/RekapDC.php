...
<!-- Page Heading -->
<h1 class="h3 mb-2 text-gray-800">Rekap Drop Core WARU - Google Sheet</h1>
...
$(document).ready(function() {
    tabel = $('#rekap-dc').DataTable({
        ...
        "ajax":
        {
            "url": "<?php echo base_url('Data_Validasi/WRU/view_rdc') ?>", // URL file untuk proses select datanya
            "type": "POST"
        },
        "deferRender": true,
