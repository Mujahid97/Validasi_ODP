...
<div class="card shadow mb-4">
  ...
  <div class="card-body">
    <div class="table-responsive">
      <table class="table table-bordered" id="detail-myr" width="100%" cellspacing="0">
        <thead>
          <tr>
...
$(document).ready(function() {
    tabel = $('#detail-myr').DataTable({
        ...
        "ajax":
        {
            "url": "<?php echo base_url('Data_Validasi/MYR/view_detail') ?>", // URL file untuk proses select datanya
            "type": "POST"
        },
        "deferRender": true,
