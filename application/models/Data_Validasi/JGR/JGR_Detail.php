...
class JGR_Detail extends CI_Model {
  public function filter($search, $limit, $start, $order_field, $order_ascdesc){
    ...
    return $this->db->get('DETAIL_JGR')->result_array(); // Eksekusi query sql sesuai kondisi diatas
  }

  public function count_all(){
    return $this->db->count_all('DETAIL_JGR'); // Untuk menghitung semua data siswa
  }
  ...
  public function count_filter($search){
    ...
    $this->db->or_like('LOSS', $search);
    $this->db->or_like('COMMENT', $search);
    return $this->db->get('DETAIL_JGR')->num_rows(); // Untuk menghitung jumlah data sesuai dengan filter pada textbox pencarian
  }
}