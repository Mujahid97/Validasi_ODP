...
class DMO_Monitoring extends CI_Model {
  public function filter($search, $limit, $start, $order_field, $order_ascdesc){
    ...
    return $this->db->get('VALIDASI_DMO')->result_array(); // Eksekusi query sql sesuai kondisi diatas
  }

  public function count_all(){
    return $this->db->count_all('VALIDASI_DMO'); // Untuk menghitung semua data siswa
  }
  ...
  public function count_filter($search){
    ...
    $this->db->or_like('offline', $search);
    $this->db->or_like('loss_now', $search);
    return $this->db->get('VALIDASI_DMO')->num_rows(); // Untuk menghitung jumlah data sesuai dengan filter pada textbox pencarian
  }
}