...
<!-- Page Heading -->
<h1 class="h3 mb-2 text-gray-800">Rekap Drop Core JAGIR</h1>
...
<div class="card shadow mb-4">
  ...
  <div class="card-body">
    <div class="table-responsive">
      <table class="table table-bordered" id="detail-jgr" width="100%" cellspacing="0">
        <thead>
          <tr>
...
$(document).ready(function() {
    tabel = $('#detail-jgr').DataTable({
        ...
        "ajax":
        {
            "url": "<?php echo base_url('Data_Validasi/JGR/view_detail') ?>", // URL file untuk proses select datanya
            "type": "POST"
        },
        "deferRender": true,
